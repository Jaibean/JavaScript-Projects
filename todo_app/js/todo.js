...
function get_todos() {
	...
	// if the input is not null thenJSON.parse will communicate with the web browser to make the task a JavaScript object
	if (todos_str !== null) {
...
function add() {
	//this takes the inputed task and creates a variable od it
	var task = document.getElementById('task').value;
	
	var todos = get_todos;
	//this adds a new task at the end of tharray 
	todos.push(task);
...
// this function keeps the tasks permanerlt displayed on the screen
function show() {
